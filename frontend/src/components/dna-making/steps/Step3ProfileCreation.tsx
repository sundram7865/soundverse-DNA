      ...
      <div className="rounded-2xl bg-[#1A1A1A] p-6 md:p-10 border border-[#2A2A2A] text-white max-w-7xl flex flex-col gap-10">
        <div className="flex flex-col sm:flex-row gap-10">
          ...
          <div className="flex-1 space-y-4 text-sm">
            {/* Creator Name */}
            <div>
              <label className="block mb-1" style={{ fontFamily: 'Power Grotesk', fontWeight: 'normal' }}>
                Creator Name
              </label>
              <input
                type="text"
          ...
          <div className="flex flex-col items-center justify-start w-full md:w-1/3">
            <div className="relative w-40 h-40 rounded-full border border-[#333] bg-[#121212] flex items-center justify-center overflow-hidden">
              {imagePreview ? (
                <img
                  src={imagePreview}
                  alt="Profile preview"
        ...
        <div className="flex justify-center">
          <button
            onClick={handleDone}
            className="bg-[#007D49] hover:bg-[#006341] transition px-10 py-3 rounded-full font-medium text-white text-sm cursor-pointer"
          >
            Done
          </button>
        </div>
